jQuery("#simulation")
  .on("click", ".s-bf717fdd-db9a-4c9f-9f6a-366889726e45 .click", function(event, data) {
  ...
  .on("pageload", ".s-bf717fdd-db9a-4c9f-9f6a-366889726e45 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusin", ".s-bf717fdd-db9a-4c9f-9f6a-366889726e45 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
